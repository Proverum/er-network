...
async function main() {
    try {
        ...
        if (!userExists) {
            console.log('An identity for the user "clerk3" does not exist in the wallet');
        ...
        await gateway.connect(ccpPath, { wallet: wallet, identity: 'admin', discovery: { enabled: true, asLocalhost: false } });
