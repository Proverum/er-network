...
console.log("this is the ccpPath to get connection-municipality4.json", ccpPath);
...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca.municipality4.example.com'];
        ...
        const identity = X509WalletMixin.createIdentity('Municipality4MSP', enrollment.certificate, enrollment.key.toBytes());
