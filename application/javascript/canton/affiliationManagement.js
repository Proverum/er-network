...
async function main() {
    try {
        ...
        const affiliationX = await affiliationService.create({name: "canton.amtX", force: true}, adminIdentity);
        const affiliationY = await affiliationService.create({name: "canton.amtY", force: true}, adminIdentity);
        const affiliationZ = await affiliationService.create({name: "canton.amtZ", force: true}, adminIdentity);
