...
async function main() {
    try {
        ...
        const affiliationX = await affiliationService.create({name: "sp.divisionX", force: true}, adminIdentity);
        const affiliationY = await affiliationService.create({name: "sp.divisionY", force: true}, adminIdentity);
        const affiliationZ = await affiliationService.create({name: "sp.divisionZ", force: true}, adminIdentity);
