...
app.get('/api/canton2/querycitizen/:citizen_key', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
...
app.post('/api/canton2/addcitizen', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.delete('/api/canton2/deletecitizen/:citizen_key', async function (req, res) {
  try {
...
app.get('/api/canton2/queryallcitizens', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/canton2/querytransit', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/canton2/queryallvoters', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/canton2/queryvoter/:voter_key', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/canton2/queryvoterlist/:voterlist_key', async function (req, res) {
  try {
...
app.post('/api/canton2/movecitizen', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
      // Get the network (channel) our contract is deployed to.
