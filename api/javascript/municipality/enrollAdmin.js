...
console.log("this is the ccpPath to get connection-municipality.json", ccpPath);
...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca.municipality.example.com'];
        ...
        const identity = X509WalletMixin.createIdentity('MunicipalityMSP', enrollment.certificate, enrollment.key.toBytes());
