...
app.get('/api/confederation/querycitizen/:citizen_key', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
...
app.post('/api/confederation/addcitizen', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.post('/api/confederation/publishresult', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.delete('/api/confederation/deletecitizen/:citizen_key', async function (req, res) {
  try {
...
app.get('/api/confederation/queryallcitizens', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/confederation/querytransit', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/confederation/queryallvoters', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/confederation/queryvoter/:voter_key', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
...
app.get('/api/confederation/queryvoterlist/:voterlist_key', async function (req, res) {
  try {
...
app.post('/api/confederation/generateER', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
      // Get the network (channel) our contract is deployed to.
...
app.post('/api/confederation/movecitizen', async function (req, res) {
  try {
      // Create a new gateway for connecting to our peer node.3
      const gateway = await connectToGateway();
      // Get the network (channel) our contract is deployed to.
