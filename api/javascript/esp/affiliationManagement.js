...
async function main() {
    try {
        ...
        const affiliationX = await affiliationService.create({name: "esp.divisionX", force: true}, adminIdentity);
        const affiliationY = await affiliationService.create({name: "esp.divisionY", force: true}, adminIdentity);
        const affiliationZ = await affiliationService.create({name: "esp.divisionZ", force: true}, adminIdentity);
