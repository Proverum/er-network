...
console.log("this is the ccpPath to get connection-municipality3.json", ccpPath);
...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca.municipality3.example.com'];
        ...
        const identity = X509WalletMixin.createIdentity('Municipality3MSP', enrollment.certificate, enrollment.key.toBytes());
